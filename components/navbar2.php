...
<div id="navbar" class="w-full flex justify-between items-center p-4 md:flex-row">
    ...
    <div class="flex justify-end items-center gap-3">
        ...
        <a class="outline-0 w-fit h-fit p-2 font-semibold md:text-base text-sm rounded-md text-white hover:text-gray-900 ease-in-out duration-300 hover:outline-32 bg-transparent" href="http://localhost/bookstore/pages/profile.php"><i class="fa-solid fa-user fa-2xl"></i></a>
        <form method="POST">
            <button type="submit" name="logout" class="outline-0 bg-white w-fit h-fit p-2 font-semibold md:text-base text-sm rounded-md text-gray-900 ease-in-out duration-300 hover:outline-32 hover:bg-gray-900 hover:text-white ">Излогујте се</button>
        </form>
    </div>
</div>
